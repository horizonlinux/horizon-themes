...
install -p -m 644 io.github.horizonlinux.HorizonDark/contents/previews/preview.png $RPM_BUILD_ROOT%{_datadir}/plasma/look-and-feel/io.github.horizonlinux.HorizonLight/contents/previews/preview.png
